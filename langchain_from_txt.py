...
#llm = ChatOllama(model_name="mistral:7b", temperature=0.9)
embeddings = OllamaEmbeddings(model='llama3:8b')
llm = ChatOllama(model_name="llama3:8b", temperature=0.5)
...
for filename in os.listdir(template_dir):
    if filename.endswith(".md"):
        ...
        docs = RecursiveCharacterTextSplitter(chunk_size=1500, chunk_overlap=200, separators=["\n\n", "\n", " ", ""]).split_documents(pages)
